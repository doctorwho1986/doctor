 ...
 * @author doctor
 *
 * @time   2014年12月26日 下午6:07:56
 */
public class ServiceConfigEx<T> extends AbstractServiceConfig {
	private static final long serialVersionUID = 6957750020997622290L;
	...
	public ServiceConfigEx() {
	}

	public ServiceConfigEx(Service service) {
	...
	private static Integer getRandomPort(String protocol) {
		...
		if (RANDOM_PORT_MAP.containsKey(protocol)) {
			...
			String warning = String.format("{warning:'%s exist,一个jvm进程启动了多个dubbo应用'}", protocol);
			logger.info(warning);
		}
